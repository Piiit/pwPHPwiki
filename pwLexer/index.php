...
//  	$np = new TreeWalker($root, new TreePrinter());
	...
	$treeParser->registerParserToken("header", new Header());	 	$ta = new TreeWalker($root, $treeParser);
  	$o .= implode($ta->getResult());//  	TestingTools::inform($ta->getResult());	$o .= "<pre style='white-space: pre-wrap'>";	$o .= "\n\nLOG: \n".$lexer->getLog();
	$o .= "</pre>";
