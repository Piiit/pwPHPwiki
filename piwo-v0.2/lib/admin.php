...
function pw_wiki_savepage (WikiID $id, $data) {
	...
	$filename = $id->getFullPath();
	$dirname = $id->getStorage().$id->getPath(); //pw_wiki_path($id, ST_SHORT);
