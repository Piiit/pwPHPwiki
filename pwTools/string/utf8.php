...
if(empty($UTF8_LOWER_ACCENTS)) $UTF8_LOWER_ACCENTS = array(
  'à' => 'a', 'ô' => 'o', '?' => 'd', '?' => 'f', 'ë' => 'e', 'š' => 's', '?' => 'o',
  'ß' => 'ss', '?' => 'a', '?' => 'r', '?' => 't', '?' => 'n', '?' => 'a', '?' => 'k',
  '?' => 's', '?' => 'y', '?' => 'n', '?' => 'l', '?' => 'h', '?' => 'p', 'ó' => 'o',
  'ú' => 'u', '?' => 'e', 'é' => 'e', 'ç' => 'c', '?' => 'w', '?' => 'c', 'õ' => 'o',
  '?' => 's', 'ø' => 'o', '?' => 'g', '?' => 't', '?' => 's', '?' => 'e', '?' => 'c',
  '?' => 's', 'î' => 'i', '?' => 'u', '?' => 'c', '?' => 'e', '?' => 'w', '?' => 't',
  '?' => 'u', '?' => 'c', 'ö' => 'oe', 'è' => 'e', '?' => 'y', '?' => 'a', '?' => 'l',
  '?' => 'u', '?' => 'u', '?' => 's', '?' => 'g', '?' => 'l', 'ƒ' => 'f', 'ž' => 'z',
  '?' => 'w', '?' => 'b', 'å' => 'a', 'ì' => 'i', 'ï' => 'i', '?' => 'd', '?' => 't',
  '?' => 'r', 'ä' => 'ae', 'í' => 'i', '?' => 'r', 'ê' => 'e', 'ü' => 'ue', 'ò' => 'o',
  '?' => 'e', 'ñ' => 'n', '?' => 'n', '?' => 'h', '?' => 'g', '?' => 'd', '?' => 'j',
  'ÿ' => 'y', '?' => 'u', '?' => 'u', '?' => 'u', '?' => 't', 'ý' => 'y', '?' => 'o',
  'â' => 'a', '?' => 'l', '?' => 'w', '?' => 'z', '?' => 'i', 'ã' => 'a', '?' => 'g',
  '?' => 'm', '?' => 'o', '?' => 'i', 'ù' => 'u', '?' => 'i', '?' => 'z', 'á' => 'a',
  'û' => 'u', 'þ' => 'th', 'ð' => 'dh', 'æ' => 'ae', 'µ' => 'u', '?' => 'e',
);
